...
import { GithubIcon, LinkedinIcon, TwitterIcon, XComIcon } from './icons'
import { Divider } from '@nextui-org/react'

export const Footer = () => {
  return (
    <footer className='mt-10 rounded-xl m-2 md:m-4 flex flex-col bg-black/5 items-center text-black'>
        ...
        <div className='mt-6 flex items-center'>
            ...
            <a className=' inline-block w-6 h-6 mr-4'>
            <XComIcon className="hover:scale-125 transition-all ease duration-200"/>
            </a>
            <a className=' inline-block w-6 h-6 mr-4'>
        ...
        <div className="w-full mt-8 relative font-medium border-t border-solid border-light py-3 px-4 flex  flex-col items-start justify-between">
            <span className=" text-left">
             &copy;2024 X-Tools. All rights reserved.
            </span>
        </div>
    </footer>
  )
